    ...
    private void DefineValues()
    {
        switch (Type)
        {
            case ResourceType.Plants:
                    _goldValue = 1;
                    _foodValue = 2;
                    color = new Color(0.290f, 0.647f, 0.396f);
                    break;
                
            case ResourceType.Animals:
                _goldValue = 2;
                _foodValue = 3;
                color = new Color(0.721f, 0.258f, 0.274f);
                break;
            
            case ResourceType.Metals:
                _goldValue = 3;
                _foodValue = -1;
                color = new Color(0.341f, 0.341f, 0.341f);
                break;
            
            case ResourceType.FossilFuel:
                _goldValue = 4;
                _foodValue = -2;
                color = new Color(0.878f, 0.501f, 0.60f);
                break;
            
            case ResourceType.Luxury:
                _goldValue = 4;
                _foodValue = 0;
                color = new Color(0.250f, 0.364f, 0.752f);
                break;
